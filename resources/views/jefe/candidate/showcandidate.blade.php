                        ...
                        <div class="card-body">
                            ...
                            <div class="row pt-4">
                                <div class="col-md-5">
                                    <div class="card box">
                                        <div class="card-body">
                                            <h2 class="text-center text-dark">Información Reclutador</h2>
                                            <hr>
                                            <div class="row">

                                                <div class="col-md-6 text-dark">
                                                    
                                                    <span class="h6">Ethikos:</span><br>
                                                    <span class="h6">Ten_disc:</span><br>
                                                    @if ($reclutamiento->potencial_comercial)
                                                        <span class="h6">Potencia comercial:</span><br>
                                                    @endif
                                                    @if ($reclutamiento->iq_factorial)
                                                        <span class="h6">IQ factorial:</span><br>
                                                    @endif
                                                    @if ($reclutamiento->vp_test)
                                                        <span class="h6">VP test:</span><br>
                                                    @endif
                                                    <span class="h6">Comentarios:</span><br>


                                                </div>
                                                <div class="col-md-6 text-dark">
                                                    
                                                    <span class="text-center h6">{{ $reclutamiento->ethikos }}</span><br>
                                                    <span class="text-center h6">{{ $reclutamiento->ten_disc }}</span><br>
                                                    @if ($reclutamiento->potencial_comercial)
                                                        <span
                                                            class="text-center h6">{{ $reclutamiento->potencial_comercial }}</span><br>
                                                    @endif
                                                    @if ($reclutamiento->iq_factorial)
                                                        <span
                                                            class="text-center h6">{{ $reclutamiento->iq_factorial }}</span><br>
                                                    @endif
                                                    @if ($reclutamiento->vp_test)
                                                        <span
                                                            class="text-center h6">{{ $reclutamiento->vp_test }}</span><br>
                                                    @endif
                                                    <span
                                                    class="text-center h6">{{ $reclutamiento->comentarios }}</span><br>
                                ...
                                <div class="col-md-7">
                                    <div class="card box">
                                        <div class="card-body">
                                            <h2 class="text-center text-dark">Información Analista</h2>
                                            <hr>
                                            <div class="row">

                                                <div class="col-md-6 text-dark">
                                                    @if ($reclutamiento->poligrafo)
                                                        <span class="h6">Poligrafo:</span><br>
                                                    @endif
                                                    @if ($reclutamiento->visita_domiciliaria)
                                                        <span class="h6">Visita domiciliaria:</span><br>
                                                    @endif
                                                    <span class="h6">Entrevista:</span><br>
                                                ...
                                                <div class="col-md-6 text-dark">
                                                    @if ($reclutamiento->poligrafo)
                                                        <span
                                                            class="text-center h6">{{ $reclutamiento->poligrafo }}</span><br>
                                                    @endif
                                                    @if ($reclutamiento->visita_domiciliaria)
                                                        <span
                                                            class="text-center h6">{{ $reclutamiento->visita_domiciliaria }}</span><br>
                                                    @endif
                                                    <span
                                                        class="text-center h6">{{ $reclutamiento->entrevista_analista }}</span><br>
                                                </div>
                                            </div>
