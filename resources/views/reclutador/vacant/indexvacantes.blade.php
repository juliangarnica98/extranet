                    ...
                    <div class="card-body">
                        ...
                        <p class="card-description text-center">
                            {{-- <button class="btn btn-success" data-target="#Modalstore" data-toggle="modal"></button> --}}
                                    <a href="{{route('reclutador.vacantes.create')}}" class="btn btn-success"><i
                                        class="fas fa-plus"></i> Nueva vacante</a>
                            {{-- @include('admin.vacant.storevacantes') --}}
                        </p>

                        <form method="get" action="{{ route('reclutador.vacantes.search') }}">
                            <div class="form-row">
                                <div class="col-sm-10">
                                                ...
                                                <td class="text-center">
                                                    <div style="display: flex" class="text-center justify-content-center">
                                                        <div class="pl-1">
                                                            ...
                                                            @include('reclutador.vacant.showvacantes')
                                                        </div>
                                                        <div class="pl-1">
                                                            <a href="{{route('reclutador.vacantes.edit',$vacant->id)}}" class="btn btn-success"><i class="fas fa-edit"></i></a>
                                                        </div>
                                                        <div class="pl-1">
                                                            <form method="POST"
                                                                action="{{ route('reclutador.vacantes.close', $vacant->id) }}">
                                                                @csrf
