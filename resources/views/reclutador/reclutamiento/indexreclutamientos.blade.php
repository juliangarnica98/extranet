...
@endif
    <div class="page-content page-container" id="page-content">
        <h2 class="text-center text-dark pt-2 ">RECLUTADOS</h2>
        <div class="">
            ...
            <div class="row pl-3 pr-3 pt-2 justify-content-center">
                <div class="col-md-4 grid-margin stretch-card">
                    <div class="card box" style="background-color: #ffffff;height: 85vh">
                        <div class="card-body">
                            <h1 class="card-title">Candidatos Reclutados</h1>
                ...
                <div class="col-md-8 grid-margin stretch-card">
                    <div class="card box" style="background-color: #ffffff;height: 85vh">
                        <div class="card-body">
                            <h1 class="card-title">Candidatos reclutados por vacante</h1>
                            <div class="row">
                            ...
                            @foreach ($vacants as $vacant)
                                <div class="border-top border-bottom mt-1">
                                    <div class="card pl-0 pr-0 ml-0 mr-0 border-0 vancants" style="background-color: #ebebeb">
                                        ...
                                        <a href="{{ route('reclutador.reclutamientos.buscar', ['id' => $vacant->id]) }}"
