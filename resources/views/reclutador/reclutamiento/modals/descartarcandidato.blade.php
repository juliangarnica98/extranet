<div class="modal fade" id="Modaldescartar{{ $postulaciones->recruitment->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content text-dark">
            ...
            <form method="POST" action="{{route('reclutador.candidato.rechazar',[$postulaciones->cv_id,$postulaciones->vacant_id])}}">
                @csrf
