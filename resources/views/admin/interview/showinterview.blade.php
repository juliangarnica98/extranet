                                            ...
                                            @if ($cv->id == $entrevista->cv_id)
                                                ...
                                                <div class="col-sm-2 text-center text-black pt-2">
                                                    <a class="btn" href="{{ asset('storage/cvs/' . $cv->file_cv) }}"
                                                        download><h5><i class="fas fa-download text-black"></i></h5> </a>
                                                </div>
                                                <div class="col-sm-2 text-center text-black pt-2">
                                                    <b>{{ $cv->name }}</b><img style="width: 3rem;height: 3rem;border-radius: 50%"
                                                    class="img-fluid"
                                                    src="{{ asset('storage/avatars/' . $cv->photo_cv) }}" /> </div>
                                                <div class="col-sm-2 text-center text-black pt-2">{{ $cv->age }}</div>
                                                <div class="col-sm-2 text-center text-black pt-2">{{ $cv->city_address }}
                                                </div>
                                                <div class="col-sm-2 text-center text-black pt-2">
                                                    <a class="" href="{{route('admin.index.editentrevista',$entrevista->id)}}"
                                                        ><h5><i class="fas fa-pencil-alt text-black"></i></h5> </a>
                                                </div>
                                                <div class="col-sm-2 text-center text-black">
                                                    <a class="" href="{{route('admin.index.entrevistaver',$entrevista->id)}}"
                                                        ><h5><i class="fas fa-eye text-black"></i></h5> </a>
                                                </div>
                                            @endif
                                        @endforeach
                                    </div>
